...
updater_er = Updater(DataToolparamVersion = '_v12',DataToolremark = '_AQELDTXLBSDALMFBAFSA',instanceId=5)
res_er = updater_er.get_new(factor='efficiencyRatioSign',
                                SignalCalculatorparamVersion='_v12',
                                SignalCalculatoremark='_ersign',
                                save=True,
                                upload=False,
                                tableNameExt='AQELDTXLBSDALMFBAFSA')
