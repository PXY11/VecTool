...
class Signal(data_source.DataManager):
    ...
    def set_param(self,paramVersion,remark):
        ...
        '''
        self.path = '../data'
        with open(self.path+'/'+'setting'+'/'+'SignalCalculatorSetting'+'/'+'sig_setting%s%s.json'%(paramVersion,remark)) as param:
...
class DataTool():
    ...
    def __init__(self,paramVersion,remark):
        ...
        self.path = '../data'
        with open(self.path+'/'+'setting'+'/'+'DataToolSetting'+'/'+'datatool_setting%s%s.json'%(paramVersion,remark)) as param:
            self.setting = json.load(param)
...
class Updater(DataTool,SignalCalculator):
    ...
    def get_new(self,factor:str,SignalCalculatorparamVersion:str,SignalCalculatoremark:str,save=False,upload=False,tableNameExt:str=''):
        '''
        :factor :因子名
