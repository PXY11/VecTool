...
symbolSigDataTotalER = load_obj('../../data/symbolsSig/symbolsSigTotal_2021090520211104_5min_v11_ersign')['5min'] 
print('Read data done')
symbols = ["sol","ftm","uni","doge","fil","xlm","shib","axs","mana","dydx"]
...
sample_num = 8
###############################################################################
for tp_parameter in tp_param[:]: #2880
    for er_parameter in er_param[:]: #288
